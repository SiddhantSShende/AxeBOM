...
class WorkerConfig:
    ...
    s3_bucket: str = "axebom"
    s3_region: str = "us-east-1"

    tools_dir: str = ".axebom/tools"
...
def load_worker_config(name: str) -> WorkerConfig:
    ...
    cfg = WorkerConfig(
        name=name,
        env=loader.enum("AXEBOM_ENV", ("development", "staging", "production"), "development"),
        ...
        s3_bucket=loader.string_or("S3_BUCKET", "axebom"),
        s3_region=loader.string_or("S3_REGION", "us-east-1"),
        tools_dir=loader.string_or("OSINT_TOOLS_DIR", ".axebom/tools"),
