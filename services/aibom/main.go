// Command aibom is the AxeBOM aibom service.
//
// AI BOM: operator-supplied Table 10 elements, AI policy consent, compliance tagging, attestation verification.
//
